...
class TestFileIO(unittest.TestCase):
    ...
    def test_export_json_generates_proper_json_string(self):
        ...
        self.assertEqual(self.jaturing.io.export_json(), correct_json)
    ...
    def test_load_and_save_works(self):
        ...
        self.jaturing.io.import_json(json_in)
        filename = "test.json"
        self.jaturing.io.save_file(filename)

        second_machine = Jaturing()
        second_machine.io.load_file(filename)
        json_out = second_machine.io.export_json()
